...
import { ScrollAnimation, FloatingElement, ScaleIn } from "@/components/ui";
        ...
        <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden bg-white">
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                    ...
                    <div className="flex-1 text-center lg:text-left max-w-2xl">
                        ...
                        <ScrollAnimation direction="up" delay={0.1}>
                            <p className="text-xl text-gray-600 mb-10 leading-relaxed font-light">
                                meanval&apos;in akıllı otomasyon özellikli hepsi
                                bir arada ürün paketi, kağıt işlerine değil
                                tutkunuza odaklanmanızı sağlar.
                            </p>
                        </ScrollAnimation>
                    ...
                    <ScaleIn delay={0.2} className="flex-1 w-full relative">
                        ...
                        {/* Floating Element */}
                        <FloatingElement className="absolute -bottom-8 -left-8 bg-white p-4 rounded-lg shadow-xl border border-gray-100 hidden md:block">
