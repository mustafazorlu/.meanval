    ...
    return (
        <section className="border-b border-gray-100 bg-white py-10">
            <div className="container mx-auto px-6">
                ...
                <StaggerContainer className="flex flex-wrap justify-center items-center gap-12 md:gap-20 opacity-40 grayscale hover:grayscale-0 transition-all duration-500">
                    <StaggerItem>
                    ...
                    <StaggerItem>
                        <h3 className="text-xl italic font-medium text-gray-800">
                            GlobalUnion
                        </h3>
                    </StaggerItem>
                    <StaggerItem>
                ...
                <div className="flex flex-col md:flex-row gap-16">
                    <div className="flex-1">
                        ...
                        <ScrollAnimation direction="left" delay={0.1}>
                            <p className="text-lg text-gray-600 leading-relaxed mb-8">
                                meanval tekliflerinizi, sözleşmelerinizi, zaman
                                takibinizi, faturalarınızı ve raporlamanızı
                                entegre eder. İşletmeniz için işletim sistemi
                                gibidir.
                            </p>
                        </ScrollAnimation>
                    </div>
                    <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <ScrollAnimation direction="up" delay={0.1}>
                            <div className="bg-gray-50 p-8 rounded-2xl relative overflow-hidden h-full">
                        ...
                        <ScrollAnimation direction="up" delay={0.2}>
                            <div className="bg-primary-900 p-8 rounded-2xl relative overflow-hidden text-white shadow-xl transform md:-translate-y-4 h-full">
        ...
        <section className="py-20 bg-white">
            <div className="container mx-auto px-6">
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    <ScaleIn className="flex-1 w-full order-2 lg:order-1">
                    ...
                    <div className="flex-1 order-1 lg:order-2">
                        ...
                        <ScrollAnimation direction="right" delay={0.2}>
                            <p className="text-lg text-gray-600 leading-relaxed mb-6">
                                Dakikalar içinde profesyonel teklifler oluşturun
                                ve özelleştirin. Müşterilere gönderin, çevrimiçi
                                imzalatın ve otomatik olarak fatura oluşturun.
                            </p>
                            <a
                                href="#"
                ...
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    <div className="flex-1">
                        ...
                        <ScrollAnimation direction="left" delay={0.2}>
                            <p className="text-lg text-gray-600 leading-relaxed mb-6">
                                Müşterilerinizi ve devam eden projelerinizi tek
                                bir panelden yönetin. Birden fazla uygulama
                                arasında geçiş yapmadan ödemeleri, görevleri ve
                                dosyaları takip edin.
                            </p>
                            <a
                                href="#"
                                className="text-emerald-700 font-bold hover:underline flex items-center group"
                    ...
                    <ScaleIn delay={0.1} className="flex-1 w-full">
            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    <div className="flex-1 order-1 lg:order-2">
                        ...
                        <ScrollAnimation direction="right" delay={0.2}>
                            <p className="text-lg text-gray-600 leading-relaxed mb-6">
                                Ajanslar ve yazılım geliştirme için tasarlanmış,
                                onaylanmış sözleşme şablonları. Fikri
                                mülkiyetinizi koruyun ve yasal olarak bağlayıcı
            ...
            <div className="container mx-auto px-6 max-w-4xl text-center">
                ...
                <ScrollAnimation direction="up" delay={0.1}>
                    <h3 className="text-2xl md:text-4xl font-bold leading-tight text-gray-800 mb-10">
                        &quot;Yazılım ajansı kurmak isteyen herkes için meanval
                        en iyi hepsi bir arada çözüm. Tekliflerimi,
                        sözleşmelerimi ve faturalarımı mükemmel yönetiyor.&quot;
                    </h3>
                </ScrollAnimation>
                <ScrollAnimation direction="up" delay={0.2}>
