      ...
      <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-12">
        <div className="max-w-2xl">
          ...
          <p className="text-lg text-gray-600 mb-8">
            İşletmelerini yönetmek için Meanval kullanan 500.000+ üst düzey ajans
            ve kuruluşa katılın.
          </p>
          <Link
            href="/register"
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-16">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-gray-500 leading-relaxed mb-6">
              Ajanslar ve kuruluşlar için hepsi bir arada iş yönetimi işletim
              sistemi.
            </p>
            <div className="flex gap-4">
              <div className="w-8 h-8 bg-gray-100 rounded-full hover:bg-emerald-100 transition-colors cursor-pointer"></div>
              <div className="w-8 h-8 bg-gray-100 rounded-full hover:bg-emerald-100 transition-colors cursor-pointer"></div>
              <div className="w-8 h-8 bg-gray-100 rounded-full hover:bg-emerald-100 transition-colors cursor-pointer"></div>
            </div>
          </div>
